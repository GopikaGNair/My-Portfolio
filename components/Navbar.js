        ...
        <div className="md:items-center md:flex justify-between">
          <div className="left">
            <div className="flex items-center justify-between md:py-5 md:block">
              <a
                href="/"
                className="text-[25px] font-[Nunito-Bold] text-[#fff]"
              >
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                <li>
                  <a
                    href="#"
                    className="text-[#8492a6] hover:text-[#ff6a00] font-[Nunito-Bold] text-sm md:text-base px-2 py-2.5 text-center inline-flex items-center"
                  >
                    HOME
                  </a>
                </li>
