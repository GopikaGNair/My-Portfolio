...
function MyHome() {
    return (
        <section className="md:py-[8em] bg-[url('/home-shape.png')] bg-top bg-no-repeat bg-cover">
            <div className="container mx-auto lg:px-14 md:px-6 px-4">
                <div className='p-[20px]'>
                    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4  items-center">
                        <div className='mb-5 mt-3 md:mt-[50px]'>
                            <h3 className='text-[#8492a6] text-lg md:text-[25px] 2xl:text-[30px] font-[Nunito-Regular] leading-[1.625em] mb-3'>I am</h3>
                            <h1 className='text-[#161c2d] text-[32px] md:text-[40px] lg:text-[50px] 2xl:text-[60px] font-[Nunito-Bold] leading-[1em] mb-3' data-aos="fade-right" data-aos-duration="1000">Gopika Gopakumar</h1>
                            <p className='text-md md:text-[16px] xl:text-[18px] 2xl:text-[26px] text-[#8492a6] font-[Nunito-Regular] md:mt-[20px] mb-[30px]'>A creative and focused UI/UX Developer and a tech enthusiast, interested into everything tech and keen to learn new ones. I am passionate about technology, innovation and big challenging tasks on my to do list!!!</p>
                            <Link href="/Gopika-Resume.pdf" download className='border-2 border-[#e43a19] hover:bg-[#e43a19] hover:text-[#fff] text-[#161c2d] rounded-md pt-[5px] pb-[7px] px-[30px]'>Download CV</Link>
                        </div>
