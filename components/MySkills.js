...
function MySkills() {
    ...
    return (
        <section className="md:py-[4em] py-[2em] skills_section" id="skills">
            <div className="container mx-auto lg:px-14 md:px-6 px-4">
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4  items-center">
                    <div className='text-left' data-aos="fade-right" data-aos-duration="1000">
                        <h3 className='text-[#fff] text-[26px] md:text-[30px] lg:text-[40px] 2xl:text-[50px] font-[Nunito-Bold] leading-[1em] mb-3'>Skills</h3>
                    ...
                    <div className="relative max-w-lg w-full mx-auto md:mx-none grid gap-x-8 gap-y-12 sm:gap-8 md:gap-20 grid-cols-3 sm:grid-cols-6 items-center place-content-center">
                        <div title="HTML" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="CSS" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="Bootstrap" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="/bootstrap.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="Javascript" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="Sass" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sass/sass-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="TailwindCSS" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-right" data-aos-duration="2000"/>
                        ...
                        <div title="React" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
                        ...
                        <div title="NextJS" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original-wordmark.svg" style={{ filter: 'invert(1)' }} className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
                        ...
                        <div title="Git" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
                        ...
                        <div title="Photoshop" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="/photoshop.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
                        ...
                        <div title="Xd" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="/xd.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
                        ...
                        <div title="Figma" className="w-14 mx-auto flex items-center flex-col justify-center">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" className='hover:scale-125 transition-all duration-500' data-aos="flip-left" data-aos-duration="2000"/>
